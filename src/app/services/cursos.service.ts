...
export class CursosService {
  private cursos: Curso[] = [
    { id:1, categoria:'tecnologia', emoji:'💻', bg:'#E6F1FB', tag:'Tecnología', tagClass:'tag-tech',
      nombre:'React & Node.js desde cero', instructor:'por Ana Torres', rating:'4.9', reviews:'2.1k', horas:'32 horas', precio:'$129.000',
    ...
    { id:2, categoria:'diseno', emoji:'🎨', bg:'#FAECE7', tag:'Diseño', tagClass:'tag-design',
      nombre:'Figma para UX Designers', instructor:'por Marcos Ríos', rating:'4.8', reviews:'1.7k', horas:'24 horas', precio:'$99.000',
    ...
    { id:3, categoria:'negocios', emoji:'📊', bg:'#EEEDFE', tag:'Negocios', tagClass:'tag-biz',
      nombre:'Marketing Digital con IA', instructor:'por Lucía Vargas', rating:'4.7', reviews:'980', horas:'18 horas', precio:'$89.000',
    ...
    { id:4, categoria:'datos', emoji:'🤖', bg:'#E1F5EE', tag:'Datos', tagClass:'tag-data',
      nombre:'Python & Machine Learning', instructor:'por David Mora', rating:'4.9', reviews:'3.2k', horas:'40 horas', precio:'$149.000',
    ...
    { id:5, categoria:'tecnologia', emoji:'📱', bg:'#E6F1FB', tag:'Tecnología', tagClass:'tag-tech',
      nombre:'Desarrollo de Apps con Flutter', instructor:'por Sara Jiménez', rating:'4.6', reviews:'750', horas:'28 horas', precio:'$119.000',
    ...
    { id:6, categoria:'diseno', emoji:'✏️', bg:'#FAECE7', tag:'Diseño', tagClass:'tag-design',
      nombre:'Diseño Gráfico con Adobe Suite', instructor:'por Felipe Castro', rating:'4.7', reviews:'1.1k', horas:'22 horas', precio:'$109.000',
  ...
  getByCategoria(cat: string): Curso[] {
    return cat === 'all' ? this.cursos : this.cursos.filter(c => c.categoria === cat);
  }
}
